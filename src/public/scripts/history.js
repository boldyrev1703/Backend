            ...
            response.history.forEach(el => {
                ...
                <div class="historyBlock" data-id="${el.id}">
                    ...
                    <div class="history__edit">
                        <input type="text" class="history__input history__input_yearDate" value='${el.yearDate}'>
                        <input type="text" class="history__input history__input_title" value='${el.title ? el.title : ''}'>
                        <textarea class="history__input history__input_content">${el.content}</textarea>
                        <textarea class="history__input history__input_subContent">${el.subContent ? el.subContent : ''}</textarea>
                    </div>
                    <div style="display: flex;">
                        <button class="history__btn">Редактировать</button>
                        <button class="history__btn-submit">submit</button>
                    </div>
                </div>
                `;
